= Groovy Server Pages (GSP) [![Java CI](https://github.com/grails/grails-gsp/actions/workflows/gradle.yml/badge.svg)](https://github.com/grails/grails-gsp/actions/workflows/gradle.yml)
